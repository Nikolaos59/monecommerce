...
<link rel="apple-touch-icon" sizes="180x180" href="/apple-touch-icon.png">
    ...
    <title>Ecommerce<?php echo htmlspecialchars($title); ?></title>
</head>

<body>
    <header>
        <div class="">
            <nav class="topnav" id="myTopNav"><a class='title' href="<?php echo RACINE_SITE; ?>index.php" title="Mon Site">MonSite.com</a>
                <?php
